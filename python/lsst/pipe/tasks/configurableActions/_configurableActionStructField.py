...
from typing import Iterable, Mapping, Optional, TypeVar, Union, Type, Tuple, List, Any, Dict, Generator
...
class ConfigurableActionStruct:
    ...
    def __iter__(self) -> Generator[ConfigurableAction, None, None]:
...
class ConfigurableActionStructField(Field):
    ...
    def __get__(self: T, instance, owner=None, at=None, label="default"
